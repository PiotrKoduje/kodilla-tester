...
public class ComplexMapExample {
    public static void main(String[] args) {
        ...
        for (Map.Entry<Student,Grades> person : school.entrySet()){
            System.out.println("--------------------------------------");
            System.out.println("Uczeń: " + person.getKey().getFirstName() + " " + person.getKey().getLastName());
            System.out.println("Oceny: " + person.getValue().getGrades());
            System.out.println("Średnia ocen: " + person.getValue().getAverage());
        }
        System.out.println("--------------------------------------");
    }
}
